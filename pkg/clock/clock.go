...
func (c *clock) Tick(d time.Duration) <-chan time.Time { return time.Tick(d) } // nolint:staticcheck
...
// NewMockAt returns an instance of a mock clock initialised at the given time.Time.
